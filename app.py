...
with col1:
    ...
    # Displaying labels
    st.markdown(f"<h5 style='text-align: left;font-size: 12px;margin-top: -20px;'>Stayed<br> {stayed_count}<br> ({stayed_percentage:.1f}%)</h5>", unsafe_allow_html=True)
    st.markdown(f"<h5 style='text-align: right;font-size: 12px;margin-top: -20px;'>Left<br> {left_count} <br>({left_percentage:.1f}%)</h5>", unsafe_allow_html=True)
