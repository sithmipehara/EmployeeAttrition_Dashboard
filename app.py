...
.big-container {
    background-color:  #111122; /* Dark background for metric containers */
...
with col1:
    st.markdown("<div class='container1'><h6 style='text-align: center;'>Number of Data Points</h6>"
                f"<h2 style='text-align: center;'>{num_data_points}</h2></div>", unsafe_allow_html=True)

    st.markdown("<div class='container1'><h6 style='text-align: center;'>Number of Categorical Variables</h6>"
                f"<h2 style='text-align: center;'>{num_categorical_vars}</h2></div>", unsafe_allow_html=True)

    st.markdown("<div class='container1'><h6 style='text-align: center;'>Number of Numerical Variables</h6>"
                f"<h2 style='text-align: center;'>{num_numerical_vars}</h2></div>", unsafe_allow_html=True)

    st.markdown("<div class='container1'><h6 style='text-align: center;'>Response Variable</h6>"
...
with col2:
    ...
    st.markdown("<div class='container1'><h5 style='text-align: center;'><strong>{}</strong></h5>"
...
with col3:
    st.markdown("<div class='container1'>", unsafe_allow_html=True)
    st.markdown("<div class='container'><h4 style='text-align: center;'>Categorical Variable Distribution</h4>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='container1'>", unsafe_allow_html=True)
    st.markdown("<div class='container'><h4 style='text-align: center;'>Numerical Variable Distribution</h4>", unsafe_allow_html=True)
...
with col4:
    st.markdown("<div class='container1'>", unsafe_allow_html=True)
    st.markdown("<div class='container'><h4 style='text-align: center;'>Response vs Categorical Variable</h4>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='container1'>", unsafe_allow_html=True)
    st.markdown("<div class='container'><h4 style='text-align: center;'>Response vs Numerical Variable</h4>", unsafe_allow_html=True)
