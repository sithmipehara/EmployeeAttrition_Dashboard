...
"""
    cat_var = st.selectbox(label=    st.markdown(selectbox_label, unsafe_allow_html=True), options=df.select_dtypes(include='object').columns, format_func=lambda x: x, label_visibility="collapsed")
